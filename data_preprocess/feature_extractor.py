...
class FeatureExtractor:
    ...
    def add_features(self):
        ...
        self.features.extend([flow_ack,flow_cwr,flow_ece,flow_fin])
        ...
        f_syn = FlowSyn('f_syn')
        f_urg = FlowUrg('f_urg')
        self.features.extend([f_pro,f_psh,f_rst,f_syn,f_urg])
        ...
        self.features.extend([fo_pl_max,fo_pl_min,fo_pl_std,fo_pl_mean])
