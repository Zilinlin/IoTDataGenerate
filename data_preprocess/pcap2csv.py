...
# dir_name means the directory include several pcap files.
def getfiles(dir_name):
    pcap_file_names = os.listdir(r'dir_name')
    print(pcap_file_names)
    return pcap_file_names


def get_csv_dataset(dir_name, pcap_file_name):
    input_file_path = "dir_name" + pcap_file_name
    output_file_path = "dir_name" + pcap_file_name + '_.csv'
